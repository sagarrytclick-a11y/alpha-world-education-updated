...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center bg-white pt-24 pb-16 sm:pt-28 sm:pb-20 overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4 sm:gap-x-8 mb-10 w-full max-w-lg">
              {[
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-5 mb-8 sm:mb-12 w-full sm:w-auto">
              ...
              <button className="group flex items-center gap-3 sm:gap-4 px-4 sm:px-6 py-3 sm:py-4 rounded-2xl border border-slate-100 hover:bg-slate-50 transition-colors">
                ...
                <span className="text-xs sm:text-sm font-bold text-slate-900">How It Works</span>
              </button>
            </div>
            ...
            <div className="flex items-center gap-4 sm:gap-8 pt-6 sm:pt-8 border-t border-slate-100 w-full justify-center lg:justify-start">
               <div className="flex flex-col">
                  <span className="text-xl sm:text-2xl font-black text-slate-900">15k+</span>
                  <span className="text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Students Placed</span>
               </div>
               <div className="flex flex-col border-x border-slate-100 px-4 sm:px-8">
                  ...
                  <span className="text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Universities</span>
               </div>
               <div className="flex flex-col">
                  <span className="text-xl sm:text-2xl font-black text-slate-900">98%</span>
                  <span className="text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-tighter">Visa Success</span>
               </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 relative flex justify-center lg:justify-end mt-8 lg:mt-0">
            <div className="relative w-full max-w-[350px] sm:max-w-[450px]">
              ...
              <div className="absolute -top-4 sm:-top-6 -right-4 sm:-right-6 bg-white p-3 sm:p-4 rounded-2xl sm:rounded-3xl shadow-xl border border-slate-50 flex flex-col items-center animate-bounce-slow">
              ...
              <div className="absolute -bottom-6 sm:-bottom-8 -left-6 sm:-left-8 bg-slate-900 text-white p-4 sm:p-5 rounded-2xl sm:rounded-3xl shadow-2xl w-40 sm:w-48">
